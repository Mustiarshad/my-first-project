...
## Footer
honestly just testing out the syntax, seems kinda weird but figured out that "#" symbol represents what the font size will be, like will it be a heading, sub heading and so on, to add bullets, you use "-" or "*" symbol. 
